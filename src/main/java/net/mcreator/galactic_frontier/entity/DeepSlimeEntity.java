...
package net.mcreator.galactic_frontier.entity;
...
import net.mcreator.galactic_frontier.procedures.DeepSlimeParticleSpawningConditionProcedure;
import net.mcreator.galactic_frontier.procedures.DeepSlimeOnEntityTickUpdateProcedure;
import net.mcreator.galactic_frontier.procedures.DeepSlimeNaturalEntitySpawningConditionProcedure;
import net.mcreator.galactic_frontier.procedures.DeepSlimeEntityIsHurtProcedure;
import net.mcreator.galactic_frontier.particle.ToxicParticleParticle;
import net.mcreator.galactic_frontier.item.DeepSlimeBallItem;
import net.mcreator.galactic_frontier.entity.renderer.DeepSlimeRenderer;
...
public class DeepSlimeEntity extends GalacticFrontierModElements.ModElement {
	public static EntityType entity = null;
	public DeepSlimeEntity(GalacticFrontierModElements instance) {
		super(instance, 343);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DeepSlimeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
				...
				.size(0.8f, 0.8f)).build("deep_slime").setRegistryName("deep_slime");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -3394561, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("deep_slime_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.IN_WATER, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return DeepSlimeNaturalEntitySpawningConditionProcedure.executeProcedure(ImmutableMap.of("y", y));
				});
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(DeepSlimeBallItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				DeepSlimeEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				DeepSlimeOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void livingTick() {
			...
			Entity entity = this;
			if (DeepSlimeParticleSpawningConditionProcedure.executeProcedure(ImmutableMap.of("entity", entity)))
				for (int l = 0; l < 1; ++l) {
					...
					world.addParticle(ToxicParticleParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}
