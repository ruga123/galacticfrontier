...
public class MartianAxeItem extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:martian_axe")
	public static final Item block = null;
	public MartianAxeItem(GalacticFrontierModElements instance) {
		super(instance, 126);
	}
	...
	public void initElements() {
		...
		}, 1, -2.9f, new Item.Properties().group(AlloysItemGroup.tab)) {
			@Override
