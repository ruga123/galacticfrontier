...
public class AmethystItem extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:amethyst")
	public static final Item block = null;
	public AmethystItem(GalacticFrontierModElements instance) {
		super(instance, 110);
	}
