...
public class TitaniumBlockBlock extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:titanium_block")
	public static final Block block = null;
	public TitaniumBlockBlock(GalacticFrontierModElements instance) {
		super(instance, 56);
	}
