...
import net.mcreator.galactic_frontier.procedures.SeaBerryStage3UpdateTickProcedure;
...
public class SeaBerryStage3Block extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:sea_berry_stage_3")
	public static final Block block = null;
	public SeaBerryStage3Block(GalacticFrontierModElements instance) {
		super(instance, 359);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("sea_berry_stage_3");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SeaBerryStage3UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
