...
public class FrostedSandBlock extends GalacticFrontierModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("galactic_frontier:frosted_sand_match"),
			...
			event.getRegistry().register(feature.setRegistryName("frosted_sand"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("galactic_frontier:frosted_sand"), configuredFeature);
		}
	}
	@SubscribeEvent
