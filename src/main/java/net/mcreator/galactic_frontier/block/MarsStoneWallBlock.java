...
public class MarsStoneWallBlock extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:mars_stone_wall")
	public static final Block block = null;
	public MarsStoneWallBlock(GalacticFrontierModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mars_stone_wall");
		}
