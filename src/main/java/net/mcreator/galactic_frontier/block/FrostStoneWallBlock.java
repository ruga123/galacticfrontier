...
public class FrostStoneWallBlock extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:frost_stone_wall")
	public static final Block block = null;
	public FrostStoneWallBlock(GalacticFrontierModElements instance) {
		super(instance, 327);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("frost_stone_wall");
		}
