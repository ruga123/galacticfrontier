...
import net.mcreator.galactic_frontier.procedures.SeaberryStage2UpdateTickProcedure;
...
public class SeaberryStage2Block extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:seaberry_stage_2")
	public static final Block block = null;
	public SeaberryStage2Block(GalacticFrontierModElements instance) {
		super(instance, 358);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("seaberry_stage_2");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SeaberryStage2UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
