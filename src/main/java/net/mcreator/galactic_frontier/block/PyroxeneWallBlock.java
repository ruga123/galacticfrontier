...
public class PyroxeneWallBlock extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:pyroxene_wall")
	public static final Block block = null;
	public PyroxeneWallBlock(GalacticFrontierModElements instance) {
		super(instance, 72);
	}
