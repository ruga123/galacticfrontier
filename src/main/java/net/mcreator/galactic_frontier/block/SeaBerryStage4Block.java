...
import net.mcreator.galactic_frontier.procedures.SeaBerryStage4UpdateTickProcedure;
...
public class SeaBerryStage4Block extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:sea_berry_stage_4")
	public static final Block block = null;
	public SeaBerryStage4Block(GalacticFrontierModElements instance) {
		super(instance, 360);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("sea_berry_stage_4");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SeaBerryStage4UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
