...
public class PyroxeneStairBlock extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:pyroxene_stair")
	public static final Block block = null;
	public PyroxeneStairBlock(GalacticFrontierModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("pyroxene_stair");
		}
