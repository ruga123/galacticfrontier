...
public class CobbledFroststoneWallBlock extends GalacticFrontierModElements.ModElement {
	@ObjectHolder("galactic_frontier:cobbled_froststone_wall")
	public static final Block block = null;
	public CobbledFroststoneWallBlock(GalacticFrontierModElements instance) {
		super(instance, 324);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 5f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("cobbled_froststone_wall");
		}
